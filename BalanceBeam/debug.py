...
STATES = [State(name='IDLE', id=0, devices={'master': DeviceState(values={}, events=[]), 'tablet': DeviceState(values={}, events=[])}), State(name='BALANCEBEAM', id=1, devices={'master': DeviceState(values=OrderedDict(), events=['homeRedCar', 'homeBlueCar', 'dropRed', 'dropBlue', 'testBlue']), 'tablet': DeviceState(values={}, events=[])})]
