...
STATES = [State(name='IDLE', id=0, devices={'master': DeviceState(values={}, events=[]), 'tablet': DeviceState(values={}, events=[])}), State(name='BALLLOOPINGTEST', id=1, devices={'master': DeviceState(values=OrderedDict(), events=['threeBallCycle']), 'tablet': DeviceState(values={}, events=[])})]
